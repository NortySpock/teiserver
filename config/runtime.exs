...
config :prometheus, Teiserver.PrometheusMetrics.PhoenixInstrumenter,
...
config :prometheus, Teiserver.PrometheusMetrics.PipelineInstrumenter,
...
config :prometheus, Teiserver.PrometheusMetrics.PrometheusExporter,
  path: "/metrics2",
  ## or :protobuf, or :text
  format: :auto,
  registry: :default,
